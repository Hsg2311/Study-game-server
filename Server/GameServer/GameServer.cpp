...
//	// ----------------------절취선------------------------- 위의 코드가 이 선 아래로 재배치 금지
//}
//
//void Consumer( )
//{
//	// ----------------------절취선------------------------- 아래의 코드가 이 선 위로 재배치 금지
...
int main( )
{
	...
	// Memory Model (정책)
	// 1) Sequentially Consistent (순차적 일관성) / seq_cst
	// 2) Acquire-Release (획득-방출) / acquire, release
	// 3) Relaxed (완화) / relaxed
	...
	// 2) acquire-release
	//		- 딱 중간!
	//		- release 명령 이전의 메모리 명령들이 해당 명령 이후로 재배치되는 것을 금지
